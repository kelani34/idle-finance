    ...
    <main className="bg-[#070708] overflow-hidden">
      ...
      <section className="max-w-[1235px] mx-auto relative px-5 z-10 space-y-[46px] md:pt-[113px] pt-[77px]">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex md:flex-row flex-col md:p-5 p-3.5 gap-[9.68px]">
            <div className="bg-[#0B0B17] md:space-y-[27px] space-y-[18.671px] w-full relative overflow-hidden p-5 rounded-[16px]">
